...
namespace BoardGameLeagueUI
{
    ...
    /// <summary>
    /// Interaction logic for ZoomAndPanChart.xaml. Adapted from https://lvcharts.net/App/examples/v1/wpf/Zooming%20and%20panning.
    /// </summary>
    public partial class ZoomAndPanChart : INotifyPropertyChanged
    {
        private ZoomingOptions _zoomingMode;

        public ZoomAndPanChart()
        {
            InitializeComponent();
